...
builder.Services.AddScoped<PositionPnlCalculator>();
builder.Services.AddScoped<ILocalStorageService, LocalStorageService>();
builder.Services.AddScoped<ExchangeConnectionsService>();
...
builder.Services.AddScoped<BybitWalletService>();
builder.Services.AddScoped<IBybitPrivateStreamService, BybitPrivateStreamService>();
builder.Services.AddScoped<ActiveOrdersService>();
builder.Services.AddScoped<ActivePositionsService>();
builder.Services.AddScoped<ActiveWalletService>();
...
builder.Services.AddScoped<IWalletService>(sp => sp.GetRequiredService<ActiveWalletService>());
...
builder.Services.AddScoped<BybitTickerService>();
builder.Services.AddScoped<ITickersService>(sp => sp.GetRequiredService<BybitTickerService>());
builder.Services.AddScoped<IExchangeService>(sp => sp.GetRequiredService<IExchangeServiceFactory>().Create(null));
builder.Services.AddScoped<AmberdataDerivativesGraphQl>();
builder.Services.AddScoped<AmberdataPositionsService>();
builder.Services.AddScoped<BybitOptionMarketDataService>();
builder.Services.AddScoped<IOptionMarketDataService>(sp => sp.GetRequiredService<BybitOptionMarketDataService>());
...
builder.Services.AddScoped<PositionCardViewModelFactory>();
builder.Services.AddScoped<ExchangeSnapshotLegSyncService>();
builder.Services.AddScoped<DvolIndexService>();
builder.Services.AddTransient<PositionViewModel>();
builder.Services.AddTransient<PositionCreateViewModel>();
...
builder.Services.AddScoped<ITradingHistoryRealtimeMonitorService, TradingHistoryRealtimeMonitorService>();
